...
<body>
  ...
  <footer class="footer">
    <div class="footerLogo">
      <div class="footerLogoBox">
        <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Pawtopia Logo" class="footerLogoImg">
      </div>
    </div>
    ...
    <div class="footerInfo">
      ...
      <div class="footerSocials">
        <a href="#"><img src="<?php echo e(asset('images/ig.svg')); ?>" alt="Instagram" class="footerSocialIcon"></a>
        <a href="#"><img src="<?php echo e(asset('images/x.svg')); ?>" alt="X" class="footerSocialIcon"></a>
        <a href="#"><img src="<?php echo e(asset('images/yt.svg')); ?>" alt="YouTube" class="footerSocialIcon"></a>
        <a href="#"><img src="<?php echo e(asset('images/tiktok.svg')); ?>" alt="TikTok" class="footerSocialIcon"></a>
      </div>
    </div>

    <nav class="footerNav">
      <a href="<?php echo e(route('home')); ?>" class="footerNavLink">Home</a>
      <a href="<?php echo e(route('calendar')); ?>" class="footerNavLink">Booking</a>
      <a href="<?php echo e(route('contact')); ?>" class="footerNavLink">Contact</a>
      <?php if(auth()->guard('member')->check()): ?>
        <a href="<?php echo e(route('history')); ?>" class="footerNavLink">My Bookings</a>
      <?php else: ?>
        <a href="<?php echo e(route('register.page')); ?>" class="footerNavLink">Login / Register</a>
      <?php endif; ?>
    </nav>

    <img src="<?php echo e(asset('images/footer.svg')); ?>" alt="Footer Decoration" class="footerDecorationImg">
  ...
  <div id="thankYouModal" class="modal">
    <div class="modal-content">
      ...
      <img src="<?php echo e(asset('images/footer.gif')); ?>" alt="Thank You" style="width: 250px; height: 250px; margin-top: 50px;">
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/layouts/footer.blade.php ENDPATH**/ ?>