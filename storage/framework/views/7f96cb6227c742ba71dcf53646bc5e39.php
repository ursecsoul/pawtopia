...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dashboard-header','data' => ['title' => 'Customer Testimonials','subtitle' => 'Reviews from verified customers with completed bookings','icon' => 'star']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Customer Testimonials','subtitle' => 'Reviews from verified customers with completed bookings','icon' => 'star']); ?>
        ...
        <div class="stats-summary">
            <div class="summary-card">
                <div class="summary-icon">
                    <img src="<?php echo e(asset('images/komen.svg')); ?>" alt="Reviews Icon" class="icon-image">
                </div>
                <div class="summary-content">
                    <div class="summary-number" id="totalReviews"><?php echo e(number_format($totalTestimonials)); ?></div>
                    <div class="summary-label">Total Testimonials</div>
                </div>
            </div>
            <div class="summary-card">
                <div class="summary-icon average">
                    <img src="<?php echo e(asset('images/chart.svg')); ?>" alt="Chart Icon" class="icon-image">
                </div>
                <div class="summary-content">
            ...
            <div class="summary-card">
                <div class="summary-icon monthly">
                    <img src="<?php echo e(asset('images/kalender.svg')); ?>" alt="Calendar Icon" class="icon-image">
                </div>
                <div class="summary-content">
            ...
            <div class="summary-card">
                <div class="summary-icon positive">
                    <img src="<?php echo e(asset('images/star.svg')); ?>" alt="Star Icon" class="icon-image">
                </div>
                <div class="summary-content">
        ...
        <div class="content-card">
            ...
            <div class="content-header">
                ...
                <div class="content-controls">
                    <form method="GET" action="<?php echo e(route('admin.testimoni')); ?>" class="controls-form" style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search testimonials..." class="search-input">
                        </div>
                        <?php if(request('search') || request('rating')): ?>
                            <a href="<?php echo e(route('admin.testimoni')); ?>" class="action-btn" style="background:#DC3545;color:#fff;">Clear</a>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
                ...
                <table class="testimonial-table">
                    ...
                    <tbody id="testimonialTableBody">
                        <?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-rating="<?php echo e($testimonial->rating); ?>">
                                <td>
                                    <?php echo e(($testimonials->currentPage() - 1) * $testimonials->perPage() + $loop->iteration); ?>

                                </td>
                                <td>
                                    <div class="customer-name"><?php echo e($testimonial->member->name ?? 'Member'); ?></div>
                                    <div class="customer-email" style="font-size:0.85rem;color:#888;"><?php echo e($testimonial->member->email ?? ''); ?></div>
                                </td>
                                <td>
                                    <div class="testimonial-text"><?php echo e($testimonial->message); ?></div>
                                    <div style="font-size:0.8rem;color:#999;margin-top:4px;">
                                        Booking: <?php echo e($testimonial->booking->service_type ?? ''); ?> - <?php echo e($testimonial->booking->pet_name ?? ''); ?>
                                ...
                                <td>
                                    <div class="rating-display">
                                        <div class="rating-score"><?php echo e($testimonial->rating); ?>/5</div>
                                        <div class="star-rating">
                                            <?php for($i=1;$i<=5;$i++): ?>
                                                <span class="star <?php echo e($i <= $testimonial->rating ? 'filled' : 'empty'); ?>">★</span>
                                            <?php endfor; ?>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <form id="delete-form-<?php echo e($testimonial->id); ?>" action="<?php echo e(route('admin.testimonials.destroy', $testimonial)); ?>" method="POST" onsubmit="return confirm('Delete this testimonial?')">
                                            <?php echo csrf_field(); ?>
            ...
            <?php if($testimonials->hasPages()): ?>
                <div class="pagination-wrapper">
                    <?php echo e($testimonials->appends(request()->query())->links('pagination::bootstrap-4')); ?>

                    <div id="pageInfo" class="page-info">
                        Showing <?php echo e($testimonials->firstItem()); ?> to <?php echo e($testimonials->lastItem()); ?> of <?php echo e($testimonials->total()); ?> entries
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/admin/testimoni.blade.php ENDPATH**/ ?>