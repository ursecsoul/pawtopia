...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <img src="<?php echo e(asset('images/dog-cat.png')); ?>" class="hero-image" alt="Pets">
            <div class="hero-text">
                <h1>PAWFECTLY<br><span class="cozy">COZY</span></h1>
                <p>Your pet's happy place</p>
                <a href="<?php echo e(route('register')); ?>" class="cta-action">
        ...
        <div class="about-container">
            ...
            <div class="about-images">
                <div class="about-images-row">
                    <img src="<?php echo e(asset('images/kucing1.svg')); ?>" alt="Cat">
                    <img src="<?php echo e(asset('images/merah.svg')); ?>" alt="Red Shape">
                </div>
                <div class="about-images-row">
                    <img src="<?php echo e(asset('images/cream.svg')); ?>" alt="Cream Shape">
                    <img src="<?php echo e(asset('images/anjing1.svg')); ?>" alt="Dog">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="services-container">
            ...
            <div class="services-list">
                <div class="service-item">
                    <img src="<?php echo e(asset('images/playtime.svg')); ?>" alt="Playtime galore">
                    <p>Playtime galore</p>
                </div>
                <div class="service-item">
                    <img src="<?php echo e(asset('images/nap.svg')); ?>" alt="Cozy nap spots">
                    <p>Cozy nap spots</p>
                </div>
                <div class="service-item">
                    <img src="<?php echo e(asset('images/treats.svg')); ?>" alt="Yummy bites & licks">
                    <p>Yummy bites & licks</p>
                </div>
                <div class="service-item">
                    <img src="<?php echo e(asset('images/social.svg')); ?>" alt="Safe pet socializing">
                    <p>Safe pet socializing</p>
                </div>
                <div class="service-item">
                    <img src="<?php echo e(asset('images/pickup.svg')); ?>" alt="Pick-up & drop-off">
    ...
    <section>
        <div class="gambar">
            <img src="<?php echo e(asset('images/gambar.svg')); ?>" alt="Dog">
        </div>      
    </section>
...
<div class="why-choose">
    ...
    <img src="<?php echo e(asset('images/Heart with dog paw.svg')); ?>" alt="Professional Care Icon">
</div>
    ...
    <div class="feature-card">
        <div class="feature-icon">
    <img src="<?php echo e(asset('images/Schedule.svg')); ?>" alt="Flexible Scheduling Icon">
</div>
    ...
    <div class="feature-card">
        <div class="feature-icon">
    <img src="<?php echo e(asset('images/Tennis Ball.svg')); ?>" alt="Fun Activities Icon">
</div>
    ...
    <div class="feature-card">
        <div class="feature-icon">
    <img src="<?php echo e(asset('images/In Transit.svg')); ?>" alt="Pet Shuttle Icon">
</div>
...
<section class="cozy-container">
    <div class="cozy-left">
        ...
        <a href="<?php echo e(route('booking')); ?>" class="book-btn">Book a Spot</a>
    </div>
    <div class="cozy-right">
        <img src="<?php echo e(asset('images/orang.svg')); ?>" alt="Woman holding a cat" />
    </div>
</section>
...
</html><?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/landing.blade.php ENDPATH**/ ?>