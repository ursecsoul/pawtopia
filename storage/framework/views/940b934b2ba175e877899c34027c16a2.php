...
document.addEventListener('keydown', function(event) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch("<?php echo e(route('admin.bookings.index')); ?>")
      .then(res => res.json())
      .then(data => {
    ...
    if (addBookingForm) {
        addBookingForm.addEventListener('submit', function(e) {
            ...
            const url = isEditing ? `<?php echo e(url('/admin/bookings')); ?>/${editingIdInput.value}` : "<?php echo e(route('admin.bookings.store')); ?>";
    ...
    if (statusForm) {
        statusForm.addEventListener('submit', function(e) {
            ...
            fetch(`<?php echo e(url('/admin/booking')); ?>/${bookingId}/status`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken || '',
    ...
    function renderPagination() {
        ...
        paginationHTML += `
            <button class="pagination-btn" onclick="changePage(${currentPage - 1})" ${currentPage === 1 ? 'disabled' : ''} title="Previous">
                <img class="nav-img" src="<?php echo e(asset('images/kiri.svg')); ?>" alt="Previous" style="width: 16px; height: 16px;">
            </button>
        `;
        ...
        paginationHTML += `
            <button class="pagination-btn" onclick="changePage(${currentPage + 1})" ${currentPage === totalPages ? 'disabled' : ''} title="Next">
                <img class="nav-img" src="<?php echo e(asset('images/kanan.svg')); ?>" alt="Next" style="width: 16px; height: 16px;">
            </button>
        `;
    ...
    function renderPagination() {
        ...
        paginationHTML += `
            <li class="page-item ${currentPage === 1 ? 'disabled' : ''}">
                <a class="page-link" href="#" onclick="changePage(${currentPage - 1}); return false;">
                    <img src="<?php echo e(asset('images/kiri.svg')); ?>" alt="Previous" class="pagination-arrow">
                </a>
            </li>
        `;
        ...
        paginationHTML += `
            <li class="page-item ${currentPage === totalPages ? 'disabled' : ''}">
                <a class="page-link" href="#" onclick="changePage(${currentPage + 1}); return false;">
                    <img src="<?php echo e(asset('images/kanan.svg')); ?>" alt="Next" class="pagination-arrow">
                </a>
            </li>
        `;
    ...
    window.editBooking = function(id) {
        ...
        fetch(`<?php echo e(url('/admin/bookings')); ?>/${id}`)
            .then(res => res.json())
            .then(data => {
                // Populate form
    ...
    window.deleteBooking = function(id) {
        ...
        fetch(`<?php echo e(url('/admin/booking')); ?>/${id}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': csrfToken || ''
            }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/admin/managebooking.blade.php ENDPATH**/ ?>