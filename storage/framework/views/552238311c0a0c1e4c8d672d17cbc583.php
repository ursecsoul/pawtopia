    ...
    <style>
        * {
        ...
        .vipaws-bg {
            ...
            width: 100%;
            height: 100%;
            background-image: url('<?php echo e(asset('images/vipaws-bg.jpg')); ?>');
...
<div class="hero">
    <div class="hero-left">
        ...
        <div class="hero-image">
            <img src="<?php echo e(asset('images/hero-pets.png')); ?>" alt="Pets">
        </div>
    </div>
        ...
        <div class="vipaws-content">
            ...
            <div class="vipaws-grid">
                <div class="vipaws-box">
                    <img src="<?php echo e(asset('images/Dollar Bag.png')); ?>" alt="discount" />
                    <h4>Exclusive Member Discount</h4>
                    <p>up to 20% on all services</p>
                </div>
                <div class="vipaws-box">
                    <img src="<?php echo e(asset('images/Trophy.png')); ?>" alt="booking" />
                    <h4>Priority Booking</h4>
                    <p>Easy booking access</p>
                </div>
                <div class="vipaws-box">
                    <img src="<?php echo e(asset('images/Cat Footprint.png')); ?>" alt="daycare" />
...
<?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/register.blade.php ENDPATH**/ ?>