...
<div class="shop-hero">
    ...
    <img src="<?php echo e(asset('images/anjingkucing.png')); ?>" class="shop-hero-img" alt="Dog and Cat">
</div>
...
<div class="category-section" data-category="food">
    ...
    <div class="products-grid" id="cat-food">
        <?php $__currentLoopData = $catFood; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="product-card"
             ...
             data-description="<?php echo e(strtolower((string)$p->description)); ?>"
             data-sku="<?php echo e(strtolower((string)$p->sku)); ?>">
            <div class="product-images">
                <img src="<?php echo e($img); ?>" alt="<?php echo e($p->name); ?>">
            </div>
            <div class="product-info">
                <h3 class="product-name"><?php echo e($p->name); ?></h3>
                <p class="product-description"><?php echo e($p->description); ?></p>
                <div class="product-sku">SKU: <?php echo e($p->sku); ?></div>
                <div class="product-status status-<?php echo e($statusClass); ?>"><?php echo e($statusText); ?></div>
                <div class="product-price">
                    <span class="price-sale">Rp<?php echo e(number_format($p->price,0,',','.')); ?></span>
                </div>
            </div>
        </div>
    ...
    <div class="products-grid" id="dog-food" style="display: none;">
        <?php $__currentLoopData = $dogFood; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $statusClass = $p->status === 'active' ? 'available' : $p->status;
            $statusText = $statusClass === 'available' ? 'Available' : ($statusClass === 'coming-soon' ? 'Coming Soon' : 'Pre-order');
            $img = $p->image_path ? asset($p->image_path) : asset('images/1.svg');
...
<div class="category-section" data-category="supplies">
    ...
    <div class="products-grid" id="cat-supplies">
        <?php $__currentLoopData = $catSupplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $statusClass = $p->status === 'active' ? 'available' : $p->status;
            $statusText = $statusClass === 'available' ? 'Available' : ($statusClass === 'coming-soon' ? 'Coming Soon' : 'Pre-order');
            $img = $p->image_path ? asset($p->image_path) : asset('images/1.svg');
    ...
    <div class="products-grid" id="dog-supplies" style="display: none;">
        <?php $__currentLoopData = $dogSupplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $statusClass = $p->status === 'active' ? 'available' : $p->status;
            $statusText = $statusClass === 'available' ? 'Available' : ($statusClass === 'coming-soon' ? 'Coming Soon' : 'Pre-order');
            $img = $p->image_path ? asset($p->image_path) : asset('images/1.svg');
...
<div class="category-section" data-category="vitamins">
    ...
    <div class="products-grid" id="cat-vitamins">
        <?php $__currentLoopData = $catVitamins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $statusClass = $p->status === 'active' ? 'available' : $p->status;
            $statusText = $statusClass === 'available' ? 'Available' : ($statusClass === 'coming-soon' ? 'Coming Soon' : 'Pre-order');
            $img = $p->image_path ? asset($p->image_path) : asset('images/1.svg');
    ...
    <div class="products-grid" id="dog-vitamins" style="display: none;">
        <?php $__currentLoopData = $dogVitamins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $statusClass = $p->status === 'active' ? 'available' : $p->status;
            $statusText = $statusClass === 'available' ? 'Available' : ($statusClass === 'coming-soon' ? 'Coming Soon' : 'Pre-order');
            $img = $p->image_path ? asset($p->image_path) : asset('images/1.svg');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pawtopia\resources\views/shop.blade.php ENDPATH**/ ?>